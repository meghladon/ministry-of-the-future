...
A civic technology project testing whether Polis, the deliberation tool used by vTaiwan to resolve real political deadlocks in Taipei, can help Australians think constructively together about what this country should become.

Live site: meghladon.github.io/ministry-of-the-future
...
Polis is embedded into both pages using the official hosted Polis service (pol.is). The site does not run its own Polis instance — it embeds conversations created on the hosted platform.
...
Typography: Fraunces for prose and headlines, JetBrains Mono for labels and metadata.
...
Polis — the deliberation tool, built by the Computational Democracy Project, open-source.
vTaiwan — the Taiwanese civic-tech crew (g0v) and Digital Minister Audrey Tang's office (PDIS), who designed the four-stage process this project adapts.
The GovLab, CrowdLaw for Congress: vTaiwan (2020) — the most thorough English-language case study of the methodology.
...
For partnership or research enquiries: meaghan_ferguson@outlook.com
